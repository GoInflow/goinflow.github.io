      ...
      function containedHawkSearchInitializer($) {
          ...
          (function (HawkSearch, $) {
              ...
              HawkSearch.getCustomUrl = function () {
                  ...
                  if (lpurl.indexOf('/catalogsearch/result/') >= 0) {
                      lpurl = '';
                  }
                  return lpurl;
              };
                  ...
                  $.fn.hawksearchSuggest = function (settings) {
                      ...
                      function optionsHandler(suggestQueryField, settings) {
                          ...
                          function suggestLookup(suggestQueryField, settings) {
                              ...
                              if ((HawkSearch.SuggesterGlobal.lastVal != val || HawkSearch.SuggesterGlobal.lastVal != "") && HawkSearch.SuggesterGlobal.focus) {
                                  if (HawkSearch.SuggesterGlobal.searching == false) {
                                  HawkSearch.SuggesterGlobal.lastVal = val;
                                      HawkSearch.SuggesterGlobal.queued = '';
                                  suggestDoRemoteQuery(escape(val));
                                  } else {
                                      HawkSearch.SuggesterGlobal.queued = escape(val);
                                  }
                              }
                              return true;
                          };
                          ...
                          function suggestDoRemoteQuery(val) {
                              ...
                              jQuery.ajax({
                                  ...
                                  success: function (autoSuggestResult) {
                                      ...
                                      if (HawkSearch.SuggesterGlobal.queued !== '' && HawkSearch.SuggesterGlobal.queued !== val) {
                                          suggestDoRemoteQuery(HawkSearch.SuggesterGlobal.queued)
                                      }
                                  },
                                  error: function () {
